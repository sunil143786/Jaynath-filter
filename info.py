...
BOT_TOKEN = environ.get('BOT_TOKEN', '7644745951:AAHrr_FZtIYwaHxi2xeAOlyOsWJIuw1d09o')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6979189905').split()]
USERNAME = environ.get('USERNAME', "https://t.me/+bJha0nBvSSMwOTk1")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "apna")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Apna-files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002597269641'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002597269641'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002664106241'))
URL = environ.get('URL', 'electronic-constance-jkbot-be2339b6.koyeb.app')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002597269641'))
TUTORIAL = environ.get("TUTORIAL", "https://youtube.com/shorts/No4lAvMmVug?si=5NvzP1_Gl_fRC5Ds")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "6b6dade1e95cdc2abd4d0ae76ffc88555753c5d7 ")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'arlinks.in ')
SHORTENER_API2 = environ.get("SHORTENER_API2", "6b6dade1e95cdc2abd4d0ae76ffc88555753c5d7")
